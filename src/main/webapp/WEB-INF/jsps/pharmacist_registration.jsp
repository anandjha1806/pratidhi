...
<body>
<h2 style="text-align:center;color:red"><img alt="Pharmacist" src="../img/pharm.png" height=50>Register New Pharmacist</h2><hr>
  ...
  <div class="card-body p-5 text-center">
	  ...
	  <div class="row mb-4">
    	<div class="col">
		  ...
		  <button type="submit" class="btn btn-primary btn-block mb-4">Add Pharmacist</button>
</div>
</div>
</div>
</div>
