...
<body>
<h2 style="text-align:center;color:red"><img alt="doctor" src="../img/doctor.png" height=50>Register New Doctor</h2><hr>
  ...
  <div class="card-body p-5 text-center">
	  ...
	  <div class="row mb-4">
        ...
        <input type="text" id="form3Example2" class="form-control" name="lastName" />
		  ...
		  <div class="form-outline mb-4">
		 	<label class="form-label" for="form3Example5">Specialization</label>
		    <input type="text" id="form3Example5" class="form-control" name="specialization" />
		  </div>
